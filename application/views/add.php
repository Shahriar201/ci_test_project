		...
		<div class="card">
			<div class="card-header">
				<h3 style="padding-top: 20px;">Manage Info
					...
					<a class="btn btn-success float-right btn-sm" href="addInfo/list">
			...
			<div class="card-body">
				...
				<div class="card-body">
					...
					<form method="post" action="addInfo/save" id="myForm" enctype="multipart/form-data">

						<div class="form-row">

							<div class="form-group col-md-4">
								<label>Name</label>
								<input type="text" name="name"  class="form-control form-control-sm" placeholder="Write Your Name">
							</div>
							
							<div class="form-group col-md-4">
								<label>Email</label>
								<input type="email" name="email"  class="form-control form-control-sm" placeholder="Write Your Email">
							</div>
							
							<div class="form-group col-md-4">
								<label>Phone</label>
								<input type="text" name="phone"  class="form-control form-control-sm" placeholder="Write Your Number">
							</div>
